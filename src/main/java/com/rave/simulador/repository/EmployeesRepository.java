...
public interface EmployeesRepository extends JpaRepository<Employees, Long> {
    ...
    @Query(value = "SELECT id, gender_id, job_id, name, last_name, birth_date from employees where CONCAT(TRIM(UPPER(NAME)), ' ',  TRIM(UPPER(LAST_NAME))) = :pfull_name LIMIT 1", nativeQuery = true)
    Employees findEmployeeByName(@Param("pfull_name") String pfull_name);
    @Query(value = "SELECT id, gender_id, job_id, name, last_name, birth_date from employees where id = :pid_employeee", nativeQuery = true)
    Employees findEmployeeById(@Param("pid_employeee") Integer pid_employeee);
